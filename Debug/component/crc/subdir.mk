...
C_DEPS += \
./component/crc/fsl_adapter_crc.d 

OBJS += \
./component/crc/fsl_adapter_crc.o 


# Each subdirectory must supply rules for building sources it contributes
component/crc/%.o: ../component/crc/%.c component/crc/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-component-2f-crc

clean-component-2f-crc:
	-$(RM) ./component/crc/fsl_adapter_crc.d ./component/crc/fsl_adapter_crc.o

.PHONY: clean-component-2f-crc
